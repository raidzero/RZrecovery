...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 65 "edify/parser.y"
    { *root = (yyvsp[(1) - (1)].expr); }
    break;

  case 3:
#line 68 "edify/parser.y"
    {
