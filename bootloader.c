...
int
get_bootloader_message(struct bootloader_message *out)
{
...
int
set_bootloader_message(const struct bootloader_message *in)
{
  Volume *v = volume_for_path("/misc");
  if (v == NULL)
  {
...
static int
get_bootloader_message_mtd(struct bootloader_message *out, const Volume * v)
{
  size_t write_size;
  mtd_scan_partitions();
...
static int
get_bootloader_message_block(struct bootloader_message *out, const Volume * v)
{
...
static int
set_bootloader_message_block(const struct bootloader_message *in,
			     const Volume * v)
{
  wait_for_device(v->device);
